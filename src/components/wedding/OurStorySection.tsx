          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="rounded-2xl border border-lavender-100 bg-lavender-50/50 p-4 sm:p-6">
              <p className="text-sm leading-relaxed text-gray-600 sm:text-base">
                ...
                challenges, we've held on to each other, and found 
                our way through it all. We've grown stronger together.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-gold-100 bg-gold-50/50 p-4 sm:p-6">
              <p className="text-sm leading-relaxed text-gray-600 sm:text-base">
                ...
                arguing about which way to go even when Google Maps is clearly telling us otherwise, we realised that building a 
